      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Karyawan') ?>"><i class="fa fa-circle-o"></i> Karyawan</a></li>
            ...
            <li><a href="<?php echo base_url('Kategory') ?>"><i class="fa fa-circle-o"></i> Kategory</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i>Penjualan</a></li>
          </ul>
        </li>
      </ul>
    </section>
